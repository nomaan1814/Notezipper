...
const Register = () => {
  ...
  //      setPic({file:pics});
      ...
      //          let d=new FormData();
      //          d.append('file',pics);
      //          d.append('cloud_name','dmbpu8pgj')
      //          fetch('cloudinary://681217895355927:h38PjINXLM-XXj5WV0FtzwKOkfE@dmbpu8pgj',{
      //              method:'POST',
      //              body:d,
  ...
  return (
    ...
    <Form onSubmit={submitHandler} encType='multipart/form-data'>
      ...
      {/* {picmessage && <Errormess variant='danger'>{picmessage}</Errormess>} */}
